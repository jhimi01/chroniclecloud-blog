...
export default async function CategoryPage({
  ...
  const { category } = params; // No need for 'await' here, it's already synchronously passed.

  // Debugging category value
  console.log("Fetched category:", category);

  // Check available categories in the database (for debugging)
...
{blogs.length === 0 ? <div className="md:flex gap-5 mt-10 container mx-auto text-3xl text-gray-900 items-center justify-center">
        There is no blog post available
